...
3. Start the container.
   ...
   You may encouter something like this:
...
7. Get (copy) the certifcate from the container to your local machine.

   ``` bash
   $docker cp es01:/usr/share/elasticsearch/config/certs/http_ca.crt .
   ```

8. Make a REST API call to Elasticserach to ensure the container is running (to see everything is okay). 
...
1. Kibana console, Manament->Dev Tools
...
- Question 1-1. Show its request and results: All the resturants in California that are not Japanese. Provide a screenshot of your Kibana working (no need to show all restaurants in the screenshot). 
- Question 1-2. Show its requests and results: The restaurant names and its star (from the highest), show only the first five of them. Provide a screenshot of your Kibana working (no need to show all restaurants in the screenshot).
- Question 1-3. Show its request and result: All the resturants that is the cheapest and closest to lat: 39.39.802765 and lon: -105.087486. Provide a screenshot of your Kibana working.
- Put 1-1, 1-2, and 1-3 into a single PDF file and submit to LMS, PDF file only (db-lab-11-question-1-submission)
...
- Submit it to LMS, .py file only (db-lab-11-question-2-submission)
