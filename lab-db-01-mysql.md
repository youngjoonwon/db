...
- https://docs.docker.com/desktop/ choose your OS and install: Mac, Windows, or Linux

- run your docker desktop

- If you having trouble in Mac, uninstall old version, refer to https://docs.docker.com/desktop/cert-revoke-solution/ and install the latest version (https://docs.docker.com/desktop/release-notes/ e.g., 4.44.3).
...
- import datafile to mysql
  ...
  for windows powershell (assuming you have mysql shell):
